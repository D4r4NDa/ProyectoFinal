...
class ComidasAdapter(var lista: MutableList<ComidasPedidas>, private val onQuitarComida: (Comida) -> Unit): RecyclerView.Adapter<ComidasViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ComidasViewHolder, position: Int) {
        holder.render(lista[position], onQuitarComida)
    }
